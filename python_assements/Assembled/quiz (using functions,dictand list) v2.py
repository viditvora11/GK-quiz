...
rule = input("\nDo you want to learn the rules or continue without the rules? \npress y to learn the rules or x/enter to continue without knowing the rules : ")
...
elif status == "x" :  #using elif to the previous if for asking if they want to play the quiz.
