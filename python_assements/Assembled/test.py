...
[
    ...
    {'answer':'d','option':'a)Atlantic Ocea\nb)Indian ocean\nc)Arctic ocean\nd)Pacific ocean\n'}
     ],
[
...
def rule():
    ...
    if rule == "y" or rule == "yea" or rule == "yes":
        print("\nThe basic rules are as follows \n1. Enter the answer in a,b,c,d.\n2. You are not allowed to use help of internet\n3. You can work with people but then the score will be your and the person you playing with.\nThe following options are just help for you.\n1.If you press enter for a answer you will not get the point for it.\n2.Read the question and the options multiple times.\n3.There will be 20 questions in the quiz.")
    else:
...
while len(gkquiz)>0:
    ...
    while True:
        ...
        if user_answer=='a'or user_answer=='c' or user_answer=='b'or user_answer=='d':
