...
"19.Who was the richest man in 2020?":'c',
...
def greet():
    while True:
        ...
        if name.isalpha():
            break
        print("The data type you have used is incalid data type. (Please enter your name in alphabets only.(Please don't use spaces if you have used spaces)\n")
...
def age():
    while True:
        ...
        if age.isnumeric():
            break
        print("The data type you have used is invalid data type. Please enter your age in numbers only.(Please enter your name in alphabets only.(Please don't use spaces if you have used spaces)\n")
